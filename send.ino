...
void leer_amortiguador(){
  objeto1 =(int)analogRead(analogPin);          // realizar la lectura analógica raw
  sprintf (object1, "%03i", objeto1); 
}

void enviar_amortiguador(){
   Serial.println("Sending packet ... ");
    if(objeto1>999){
  CAN0.sendMsgBuf(0x101, 0, 4, object1); 
  }else{
  CAN0.sendMsgBuf(0x11, 0, 4, object1); 
  }
}
